			...
			if(jsonObject.result==1){
				...
				$.each(jsonObject.data, function(i, n){
					...
					$("#data-list").append("<tr>"+
						...
						"<td>"+
							"<span class=\"layui-btn layui-btn-normal layui-btn-sm\" onclick=\"detail('"+n.id+"');\">查看</span>"+
							"<span class=\"layui-btn layui-btn-primary layui-btn-sm\" onclick=\"doPass('"+n.id+"');\">通过</span>"+
							"<span class=\"layui-btn layui-btn-danger layui-btn-sm\" onclick=\"doBack('"+n.id+"');\">打回</span>"+
						"</td>"+
					"</tr>");
				});
			}else{
...
function detail(id){
	window.location.href = "system/task/detail.do?id="+id;
}
